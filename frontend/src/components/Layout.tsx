...
import { Home, Search, Settings, LogOut, Disc, FileText, Link as LinkIcon, DollarSign, Activity } from 'lucide-react'
...
const navigation = [
  ...
  { name: 'Orchestration', href: '/orchestration', icon: Activity },
