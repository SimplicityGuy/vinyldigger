...
def upgrade() -> None:
    ...
    op.create_table(
        "app_config",
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column("provider", sa.Enum("DISCOGS", "EBAY", name="oauthprovider"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("platform", sa.Enum("DISCOGS", "EBAY", "BOTH", name="searchplatform"), nullable=False),
